    ...
    <form method="POST" action="{{ route("admin.projects.update", [$project->id]) }}" enctype="multipart/form-data">
        ...
        <div class="body">
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="revisado" name="revisado" class="{{ $errors->has('revisado') ? ' is-invalid' : '' }}" value="{{ old('revisado', $project->revisado) }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="informe" name="informe" class="{{ $errors->has('informe') ? ' is-invalid' : '' }}" value="{{ old('informe', $project->informe) }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="date" id="felaboracion" name="felaboracion" class="{{ $errors->has('felaboracion') ? ' is-invalid' : '' }}" value="{{ old('felaboracion', $project->felaboracion) }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="date" id="frevision" name="frevision" class="{{ $errors->has('frevision') ? ' is-invalid' : '' }}" value="{{ old('frevision', $project->frevision) }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="rev" name="rev" class="{{ $errors->has('rev') ? ' is-invalid' : '' }}" value="{{ old('rev', $project->rev) }}" required>
                </div>
                @if($errors->has('rev'))
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="empresa" name="empresa" class="{{ $errors->has('empresa') ? ' is-invalid' : '' }}" value="{{ old('empresa', $project->empresa) }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="proyecto" name="proyecto" class="{{ $errors->has('proyecto') ? ' is-invalid' : '' }}" value="{{ old('proyecto', $project->proyecto) }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="codigo_proy" name="codigo_proy" class="{{ $errors->has('codigo_proy') ? ' is-invalid' : '' }}" value="{{ old('codigo_proy', $project->codigo_proy) }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="ubicacion" name="ubicacion" class="{{ $errors->has('ubicacion') ? ' is-invalid' : '' }}" value="{{ old('ubicacion', $project->ubicacion) }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="date" id="fentrega" name="fentrega" class="{{ $errors->has('fentrega') ? ' is-invalid' : '' }}" value="{{ old('fentrega', $project->fentrega) }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="documento" name="documento" class="{{ $errors->has('documento') ? ' is-invalid' : '' }}" value="{{ old('documento', $project->documento) }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="revisado_por" name="revisado_por" class="{{ $errors->has('revisado_por') ? ' is-invalid' : '' }}" value="{{ old('revisado_por', $project->revisado_por) }}" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="nombre_documento" name="nombre_documento" class="{{ $errors->has('nombre_documento') ? ' is-invalid' : '' }}" value="{{ old('nombre_documento', $project->nombre_documento) }}" required>
                </div>
